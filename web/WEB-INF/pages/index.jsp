        ...
        <div class="page-content">
            ...
            <div class="mdl-grid">
                <div class="mdl-cell mdl-cell--12-col center">
                    <div align="center">
                        <img src="../Excited/resources/img/home-first.png/" align="center">
                    </div>
                </div>
            </div>
            <div class="mdl-grid">
                <div class="mdl-cell mdl-cell--12-col center">
                    <div align="center">
                        <a class="mdl-button mdl-js-button mdl-color--pink-400 mdl-color-text--white"
                           href="/Excited/userRegister">立即注册</a>
                    </div>
                </div>
            </div>
            <!-- 主体2 -->
            <div class="mdl-grid">
                <div class="mdl-cell mdl-cell--4-col">
                    <div class="mdl-card mdl-shadow--2dp center">
                        <div class="mdl-card__title mdl-card--expand">
                            <img src="../Excited/resources/img/home-ill-build.png" width="100%"/>
                        </div>
                ...
                <div class="mdl-cell mdl-cell--4-col">
                    <div class="mdl-card mdl-shadow--2dp center">
                        <div class="mdl-card__title mdl-card--expand">
                            <img src="../Excited/resources/img/home-ill-platform.png" width="100%"/>
                        </div>
                        <div class="mdl-card__supporting-text mdl-typography--text-center">
                            <h5>开放</h5>
                        </div>
                ...
                <div class="mdl-cell mdl-cell--4-col">
                    <div class="mdl-card mdl-shadow--2dp center">
                        <div class="mdl-card__title mdl-card--expand">
                            <img src="../Excited/resources/img/home-ill-work.png" width="100%"/>
                        </div>
                        <div class="mdl-card__supporting-text mdl-typography--text-center">
                            <h5>共享</h5>
                        </div>
            ...
            <div class="mdl-grid">
                <div class="mdl-cell--12-col center">
                    <div align="center">
                        <a href="/Excited/main" class="mdl-button mdl-js-button mdl-button--raised mdl-color-text--white mdl-color--pink-400 button">
                            进去学习一个
                        </a>
                    </div>
                </div>
            ...
            <footer class="mdl-mini-footer">
                <div class="mdl-mini-footer__left-section center" align="center">
                    ...
                    <ul class="mdl-mini-footer__link-list">
                        <li><a href="https://github.com/xiaoyu19950911">GitHub</a></li>
                        <li><a href="">Privacy & Terms</a></li>
                        <div align="right">
                            <li><a href="/Excited/">肖宇的网站！</a></li>
                        </div>
                    </ul>
                </div>
            </footer>
