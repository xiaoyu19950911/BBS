    ...
    <header class="mdl-layout__header mdl-layout__header--scroll mdl-color--grey-50">
        <div class="mdl-layout__header-row">
            ...
            <a class="mdl-layout-title mdl-navigation__link mdl-color-text--pink-400"
               href="/Excited/board/listPosts-${post.postBoardId}">Excited</a>
            ...
            <nav class="mdl-navigation">
                <c:choose>
                    ...
                    <c:when test="${username == null}">
                        <a href="/Excited/userLogin" class="mdl-navigation__link mdl-color-text--pink-400">登录</a>
                        <a href="/Excited/userRegister" class="mdl-navigation__link mdl-color-text--pink-400">注册</a>
                    </c:when>
                </c:choose>
            </nav>
        </div>
                        ...
                        <c:when test="${username != null}">
                            <div align="right" class="center card-width">
                                <a class="mdl-button mdl-js-button mdl-color--pink-400 mdl-color-text--white"
                                   href="/Excited/addReply?replyPostId=${post.postId}&replyUserName=${username}">
                                    立即回复
                                </a>
                            </div>
                        </c:when>
