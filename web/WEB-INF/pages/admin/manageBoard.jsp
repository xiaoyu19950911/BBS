...
<div class="mdl-layout mdl-js-layout">
    <header class="mdl-layout__header mdl-layout__header--scroll mdl-color--grey-50">
        <div class="mdl-layout__header-row">
            <!-- Title -->
            <a class="mdl-layout-title mdl-navigation__link mdl-color-text--pink-400" href="/Excited/admin/manageCenter">Excited</a>
            ...
            <nav class="mdl-navigation">
                ...
                <a class="mdl-navigation__link mdl-color-text--black" href="/Excited/addBoard">添加板块</a>
            </nav>
        </div>
    </header>
                        ...
                        <table class="mdl-data-table mdl-js-data-table mdl-data-table--selectable mdl-shadow--2dp center card-width"
                            ...
                            <tr>
                                <td class="mdl-data-table__cell--non-numeric">
                                    <div align="right">
                                        <a href="/Excited/updateBoardPage?boardId=${boards.boardId}"
                                           class="mdl-button mdl-js-button mdl-color-text--pink-400">修改</a>
                                    </div>
                                </td>
                                <td class="mdl-data-table__cell--non-numeric">
                                    <div align="right">
                                        <a href="/Excited/admin/deleteBoard?boardId=${boards.boardId}"
