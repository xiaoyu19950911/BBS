...
<div class="mdl-layout mdl-js-layout">
    <header class="mdl-layout__header mdl-layout__header--scroll mdl-color--grey-50">
        <div class="mdl-layout__header-row">
            <!-- Title -->
            <a class="mdl-layout-title mdl-navigation__link mdl-color-text--pink-400" href="/Excited/admin/manageBoard">Excited</a>
                ...
                <div class="mdl-cell--4-col">
                    <div class="mdl-card mdl-shadow--2dp center card-width">
                        ...
                        <div class="mdl-card__supporting-text">
                            <form action="/Excited/admin/addBoard" method="post">
                                <table class="mdl-data-table mdl-js-data-table mdl-data-table--selectable center"
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            ...
                                            &nbsp&nbsp&nbsp
                                            <a href="/Excited/admin/manageBoard">
